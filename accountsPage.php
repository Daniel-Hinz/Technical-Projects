...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
    ...
    <h1 class="w3-xxxlarge w3-text-red"><b>Greek Life Chapter Details.</b></h1>
  ...
  <?php
    ...
    $sql = "SELECT Account.chapter_id, Account.balance, Chapter.chapter_id, Chapter.chapter_name FROM Account, Chapter WHERE Account.chapter_id = Chapter.chapter_id";
